...
if __name__ == "__main__":
    ...
    fold = int(sys.argv[3])  # int belonging to [1,10]
    ...
    multimodal_autoencoder.save(
        "{}/conv/fold_{}/multimodal_autoencoder.h5".format(base_path, fold)
    )
    encoder_shared_layer.save(
        "{}/conv/fold_{}/encoder_shared_layer.h5".format(base_path, fold)
    )
    encoder_gyr.save("{}/conv/fold_{}/encoder_gyr.h5".format(base_path, fold))
    encoder_rsfmri.save("{}/conv/fold_{}/encoder_rsfmri.h5".format(base_path, fold))
    ...
    plt.xlabel("epoch")
    plt.legend()
    plt.savefig("{}/conv/fold_{}/loss.png".format(base_path, fold))
    plt.savefig("{}/conv/fold_{}/loss.pdf".format(base_path, fold))
    plt.close()

...
subject_list = "/media/sf_StageINT/INT_fMRI_processing/url_preparation/subs_list.json"
...
for sub in subs_list:
    ...
    if not "USM" in sub:
        ...
        # os.system(cmd)
        cmd = "freeview -f /media/sf_StageINT/data/datareg/{0}/lh.white -v /media/sf_StageINT/data/datareg/{0}/{0}_func_preproc.nii.gz".format(
            sub
        )
        os.system(cmd)

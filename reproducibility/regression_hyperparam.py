# !! This version of the script has been modified for testing purposes
...
def run_slurm_job_regression(
    ...
    code_dir="/scratch/mmahaut/scripts/INT_fMRI_processing/reproducibility",
...
if __name__ == "__main__":
    ...
    params_grid = {}
    params_grid["delta"] = [0, 10, 1e-3, 1e-5]  # list values to grid_search on
    params_grid["soft_thresh"] = [0, 1.9e-4, 1e-5]

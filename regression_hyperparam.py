...
if __name__ == "__main__":
    ...
    params_grid = {}
    params_grid["delta"] = [1e-5, 1e-6, 1e-7]  # list values to grid_search on
    params_grid["soft_thresh"] = [1e-9, 1e-10, 1e-11, 1e-12]
    ...
    params_grid[
        "fold"
    ] = 4  # More folds, means better representation, but more resources used

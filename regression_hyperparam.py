...
if __name__ == "__main__":
    ...
    params_grid = {}
    params_grid["delta"] = [1e-8, 1e-9, 1e-10]  # list values to grid_search on
    params_grid["soft_thresh"] = [2e-6, 1e-6, 9e-7, 8e-7]
    params_grid["modality"] = ["gyrification"]  # ["gyrification", "tfMRI"]
